...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public NoteViewHolder(@NonNull View itemView, NoteOperator operator) {
        ...
        whiteBtn=itemView.findViewById(R.id.btn_white);
        redBtn=itemView.findViewById(R.id.btn_red);
        greenBtn= itemView.findViewById(R.id.btn_green);
