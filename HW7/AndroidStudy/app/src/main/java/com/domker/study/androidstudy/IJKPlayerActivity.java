...
public class IJKPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void init() {
       ...
       // Log.d(“VIOCE_CALL”, “max : ” + max + ” current : ” + current);
        ...
        voice.setProgress(100*current/max);
        voice.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {


            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC,(int)((max*progress/100)), AudioManager.FLAG_SHOW_UI);
              //  Log.d("sss", String.valueOf(((max*progress/100))));
            }
    ...
    private final static int REQUEST_PERMISSION = 1235;
